...
export const PANELS = [
  ...
  { id: "teamhealth", icon: "heart", label: "Team health", hint: "Burnout radar" },
  { id: "privacy", icon: "shield", label: "Privacy & Synthesis", hint: "DP compliance & GANs" },
...
export const PANEL_TITLES = {
  ...
  privacy: "Privacy & Synthesis Compliance",
